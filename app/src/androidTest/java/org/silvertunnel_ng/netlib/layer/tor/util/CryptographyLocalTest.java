 ...
 * @author Tobias Boese
 */
public class CryptographyLocalTest extends InstrumentationTestCase {
    /** */
    ...
    static {
        try {
            data = "lnx2389rfh5kfjnec974rfcne2fckjencrf95p9fuj. leekcnx4o8tgcup0tjcelgkcn509gcj6lgnw5-bkn;".getBytes(Util.UTF8);
    ...
    public void testSymmetricEncryption() throws GeneralSecurityException {
        ...
        final byte[] decrypted = new AESCounterMode(key).processStream(new AESCounterMode(key).processStream(data));
        assertTrue(Arrays.equals(decrypted, data));
    }

    public void testSha1Cloning() throws GeneralSecurityException,
            CloneNotSupportedException {
        final MessageDigest digest = MessageDigest.getInstance(Encryption.DIGEST_ALGORITHM);
