 ...
 * @author Tobias Boese
 */
public class AuthorityServersLocalTest extends InstrumentationTestCase {
    /** */
    ...
    public void testGetAuthorityIpAndPorts() throws Exception {
        // action
        final Collection<String> all = AuthorityServers.getAuthorityIpAndPorts();
    ...
    public void testGetAuthorizedAuthorityKeyIdentityKeys() throws Exception {
        // action
        final Collection<Fingerprint> all = AuthorityServers.getAuthorityDirIdentityKeyDigests();
        ...
        assertTrue("does not contain " + example1, all.contains(new FingerprintImpl(DatatypeConverter.parseHexBinary(example1))));
        final String example2 = "D586D18309DED4CD6D57C18FDB97EFA96D330566";
        assertTrue("does not contain " + example2, all.contains(new FingerprintImpl(DatatypeConverter.parseHexBinary(example2))));
    }
    ...
    public void testGetAuthorityRouters() throws Exception {
        // action
        final Collection<Router> all = AuthorityServers.getAuthorityRouters();
        ...
        assertEquals("wrong 1st element: wrong fingerprint", new FingerprintImpl(DatatypeConverter.parseHexBinary("9695DFC35FFEB861329B9F1AB04C46397020CE31")), r.getFingerprint());
        ...
        assertEquals("wrong 3rd element: wrong fingerprint", new FingerprintImpl(DatatypeConverter.parseHexBinary("7EA6EAD6FD83083C538F44038BBFA077587DD755")), r.getFingerprint());
    }
}
