...
package org.silvertunnel_ng.android_test;
 ...
 * @author Tobias Boese
 */
public class EncryptionLocalTest  extends InstrumentationTestCase {
    /** */
    ...
    private static final String PRIVATE_KEY_PEM = "-----BEGIN RSA PRIVATE KEY-----\n" +
            "MIICXAIBAAKBgQC59AffpyjQ6LLCFk09DLiqCgaARRe1wSUxnDebO3HnMZGBbYqV\n" +
            "tfJCTvF7BDwI83K8sWf2MGo6wWdEVLejPdtnb1/RmXCggsDxX4CYm08sxL3560MC\n" +
            "5hqiqPWpeLMvl2vOr30tjPWBiYK7qBmx6qCW0Kpe4KGNrqqJ1EQ00zVYNQIDAQAB\n" +
            "AoGAT9Lu0lZqkgtiOSjjrTJZzzyQf92pCO/JrJs3z55cDffcU2gXlp7NSSOkS7+M\n" +
            "mfcPqOqrCybLYz+EufN4BU5XcTpKyQpevyRarkRLIWSG1AzRiSFpNKIdmYGbTAul\n" +
            "T60Ahjyg3lwpXH6RHozLt20aURKuB/OiFpUM80Kq4aFdvd0CQQDwhpZuNhHZ3l4j\n" +
            "NlEIr74eXp2covzm79xjmf4lm8CCxWjDcS5Fnaal7OBQ5Ht0fWzIeRE8cMP6rkN1\n" +
            "n6P3tZt7AkEAxeqlEakj9NwJNBHPY018GjScZ8qnoXBRPRjviTQtPfE7OaXH9jRL\n" +
            "+ttN3D35QkyQ4EfYr9QiKx9CmMnH2CD0DwJAcRupdCyDGoRimoZ5du9GJXvy/Gz9\n" +
            "JxCXAFOzWzYyQozY5ke8LcqkSpTpK8E2eSJeXKvqOhUBZEo8uPyYm+1QLwJAGaCG\n" +
            "e0DxfPU449sihXM1DJefYPkmt4q5mjWuXo+5A/pGdvJ2b/TZmcPn0wrbSbBsWf4z\n" +
            "mqDXQ8oqb2pBTEUIFQJBAO3J0p5CtU151Z4XAwO0qMXQE1oQvwKrgsmhXtyHsjEd\n" +
            "F5H35verlNbhWlJDAhGmPfA430ETjC0S9SgdgZvBWFg=\n" +
            "-----END RSA PRIVATE KEY-----\n";
    ...
    public void testExtractRSAKeyPair() throws Exception {
        ...
        final RSAKeyPair keyPair = Encryption.extractRSAKeyPair(PRIVATE_KEY_PEM);
        ...
        assertEquals(
                ...
                EXAMPLE_ONION_DOMAIN_DERIVED_FROM_PRIVATE_KEY,
                z);
    }
    ...
    public void testFormattingPrivateKeyAsPEM() throws Exception {
        ...
        String privateKeyPEM = PRIVATE_KEY_PEM.replaceAll("\\r\\n", "\n").replaceAll("\\r", "\n");
    ...
    public void testSignData() throws IOException {
        TorHiddenServicePrivateNetAddress netAddressWithoutPort = TorNetLayerUtil.getInstance()
                .parseTorHiddenServicePrivateNetAddressFromStrings(PRIVATE_KEY_PEM, null, false);

        Assert.assertArrayEquals(PRIVATE_KEY_BYTES, netAddressWithoutPort.getPrivateKey().getEncoded());
        Assert.assertArrayEquals(EXPECTED_SIGNATURE, Encryption.signData(DATA_TO_SIGN, netAddressWithoutPort.getPrivateKey()));
        Assert.assertArrayEquals(DIGEST_OF_DATA, Encryption.getDigest(DATA_TO_SIGN));
    }
}
